...
type RouteClient interface {
	GetUsers(ctx context.Context, in *UsersParams, opts ...grpc.CallOption) (*Users, error)
}
...
func (c *routeClient) GetUsers(ctx context.Context, in *UsersParams, opts ...grpc.CallOption) (*Users, error) {
	out := new(Users)
	err := c.cc.Invoke(ctx, "/route.Route/GetUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RouteServer interface {
	GetUsers(context.Context, *UsersParams) (*Users, error)
...
func (UnimplementedRouteServer) GetUsers(context.Context, *UsersParams) (*Users, error) {
...
func _Route_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UsersParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RouteServer).GetUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/route.Route/GetUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouteServer).GetUsers(ctx, req.(*UsersParams))
	}
...
var Route_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetUsers",
			Handler:    _Route_GetUsers_Handler,
		},
	},
